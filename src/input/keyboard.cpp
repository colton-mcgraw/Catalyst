...
namespace catalyst::input
{
    ...
    std::string_view key_name(key_code code) noexcept
    {
        ...
        case key_code::num_lock:
            return "Num Lock";
        case key_code::keypad_divide:
            return "Keypad /";
        case key_code::keypad_multiply:
            return "Keypad *";
        case key_code::keypad_minus:
            return "Keypad -";
        ...
        case key_code::non_us_backslash:
            return "Non-US \\";
        case key_code::application:
            return "Application";
        case key_code::power:
            return "Power";
        case key_code::keypad_equal:
            return "Keypad =";
        case key_code::f13:
            return "F13";
        case key_code::f14:
        ...
        case key_code::keypad_comma:
            return "Keypad ,";
        case key_code::keypad_equal_as400:
            return "Keypad = (AS/400)";
